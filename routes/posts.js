...
// 게시물 생성
router.post("/post", authMiddleware, upload.single('userfile'), controller.makePosts);
...
router.put("update/:postId", authMiddleware, upload.single('userfile'), controller.modifyPosts)
